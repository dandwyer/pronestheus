...
func TestAllMetrics(t *testing.T) {
	...
	assert.Contains(t, w.Body.String(), `nest_cool_setpoint_temperature_celsius{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 21.49048`)
	...
	assert.Contains(t, w.Body.String(), `nest_status{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",mode="OFF"} 1`)
	assert.Contains(t, w.Body.String(), `nest_mode{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",mode="HEAT"} 1`)
	assert.Contains(t, w.Body.String(), `nest_eco_mode{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",mode="OFF"} 1`)
	assert.Contains(t, w.Body.String(), `nest_fan_timer_mode{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",mode="ON"} 1`)
	assert.Contains(t, w.Body.String(), `nest_eco_heat_setpoint_temperature_celsius{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 17.11803`)
	assert.Contains(t, w.Body.String(), `nest_eco_cool_setpoint_temperature_celsius{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name"} 24.44443`)
